...
title DiagonNet - Zero-Dependency Deep Learning Engine
...
cls
echo ================================================================================
echo               DIAGONNET ZERO-DEPENDENCY DEEP LEARNING ENGINE
...
echo   [3] Train DiagonNet Deep Neural Network Pipeline        (-train)
...
cls
echo ================================================================================
echo               DIAGONNET BUILD AND SYSTEM HEALTH VERIFICATION
...
echo [2/4] Compiling native binary to bin\diagonnet.exe...
echo --------------------------------------------------------------------------------
if not exist "bin" mkdir "bin"
go build -o bin\diagonnet.exe .
if %errorlevel% neq 0 goto CHECK_FAILED

if exist "bin\diagonnet.exe" (
    echo [PASS] Native executable compiled successfully: bin\diagonnet.exe
) else (
    echo [FAIL] bin\diagonnet.exe was not generated.
    goto CHECK_FAILED
)
echo.
...
echo   [PASS] 2. Native Binary Compiled (bin\diagonnet.exe)
...
cls
echo ================================================================================
echo           DIAGONNET DATASET HEALTH, QUALITY AND BOUNDING BOX AUDITOR
echo ================================================================================
echo.
...
cls
echo ================================================================================
echo   DIAGONNET REAL-TIME NEURAL DRAWING CANVAS AND WEB INFERENCE SERVER
echo ================================================================================
echo.
set /p PORT="Enter HTTP server port [default: 8081]: "
if "!PORT!"=="" set PORT=8081
set /p MODEL_PATH="Enter model weights path [default: weights\diagonnet_model.bin]: "
if "!MODEL_PATH!"=="" set MODEL_PATH=weights\diagonnet_model.bin
echo.
...
cls
echo ================================================================================
echo              DIAGONNET MATHEMATICAL AUTOGRAD AND LAYER TEST SUITE
echo ================================================================================
echo.
go test -v ./...
echo.
